 ...
 `}
    >
      ...
      <div className="flex md:hidden flex-row md:gap-6 gap-[6px] items-center justify-center">
        <Link href="https://twitter.com/0rbitco" onClick={() => handleLinkClick('Twitter', 1)}>
          <FaTwitter
            className={`${brandDarkText} hover:opacity-75 md:w-6 md:h-6 w-[20px] h-[20px]`}
          />
        </Link>
        <Link href="https://discord.gg/JVSjqaKJgV" onClick={() => handleLinkClick('Discord', 2)}>
          <FaDiscord
            className={`${brandDarkText} hover:opacity-75 md:w-6 md:h-6 w-[20px] h-[20px]`}
          />
        </Link>
        <Link href="https://github.com/0rbit-co" onClick={() => handleLinkClick('GitHub', 3)}>
          <TbBrandGithubFilled
            className={`${brandDarkText} hover:opacity-75 md:w-6 md:h-6 w-[20px] h-[20px]`}
          />
        </Link>
      ...
      <div className="md:flex hidden flex-row md:gap-6 gap-[6px] items-center justify-center">
        <Link href="https://twitter.com/0rbitco" onClick={() => handleLinkClick('Twitter', 9)}>
          <FaTwitter
            className={`${brandDarkText} hover:opacity-75 md:w-6 md:h-6 w-[15px] h-[15px]`}
          />
        </Link>
        <Link href="https://discord.gg/JVSjqaKJgV" onClick={() => handleLinkClick('Discord', 10)}>
          <FaDiscord
            className={`${brandDarkText} hover:opacity-75 md:w-6 md:h-6 w-[15px] h-[15px]`}
          />
        </Link>
        <Link href="https://github.com/0rbit-co" onClick={() => handleLinkClick('GitHub', 11)}>
          <TbBrandGithubFilled
            className={`${brandDarkText} hover:opacity-75 md:w-6 md:h-6 w-[15px] h-[15px]`}
          />
        </Link>
